...
public class TableEvents1 implements PdfPTableEvent {
	...
	public static void main(String[] args) {
		...
		try {
			// step2
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + "TableEvents1.pdf"));
			// step3
			document.open();
			// step4
