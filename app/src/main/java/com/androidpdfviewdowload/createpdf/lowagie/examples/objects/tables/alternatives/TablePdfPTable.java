 ...
 */
package com.androidpdfviewdowload.createpdf.lowagie.examples.objects.tables.alternatives;
...
public class TablePdfPTable {
	...
	public static void main(String[] args) {
		...
		try {
			...
			PdfWriter.getInstance(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + "tableattributes.pdf"));
			// open the document
			document.open();
			// add content
