...
public class FloatingBoxes implements PdfPCellEvent, PdfPTableEvent {
	...
	public static void main(String[] args) {
		...
		try {
			// step 2
			PdfWriter.getInstance(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + "FloatingBoxes.pdf"));
			// step 3
			document.open();
			// step 4
