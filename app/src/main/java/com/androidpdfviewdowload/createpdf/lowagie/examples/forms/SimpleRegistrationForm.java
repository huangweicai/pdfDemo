 ...
 */
package com.androidpdfviewdowload.createpdf.lowagie.examples.forms;
...
public class SimpleRegistrationForm implements PdfPCellEvent {
	...
	public static void main(String[] args) {
		...
		try {
			...
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + "SimpleRegistrationForm.pdf"));
			// step 3
			document.open();
			// step 4
