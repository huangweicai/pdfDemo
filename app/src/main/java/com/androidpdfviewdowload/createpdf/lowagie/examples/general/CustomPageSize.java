...
package com.androidpdfviewdowload.createpdf.lowagie.examples.general;
...
public class CustomPageSize {
	...
	public static void main(String[] args) {
		...
		pageSize.setBackgroundColor(new harmony.java.awt.Color(0xFF, 0xFF, 0xDE));
		...
		try {
			...
			PdfWriter.getInstance(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + "CustomPageSize.pdf"));
