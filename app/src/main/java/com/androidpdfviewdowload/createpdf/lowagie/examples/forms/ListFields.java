...
public class ListFields {
	...
	public static void main(String[] args) {
		...
		try {
			PrintStream stream = new PrintStream(new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + File.separator + "droidtext" + File.separator + "listfields.txt"));
