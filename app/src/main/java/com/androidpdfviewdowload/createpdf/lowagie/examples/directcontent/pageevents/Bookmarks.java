...
public class Bookmarks extends PdfPageEventHelper {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// step 2:
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + "bookmarks.pdf"));
			// step 3:
