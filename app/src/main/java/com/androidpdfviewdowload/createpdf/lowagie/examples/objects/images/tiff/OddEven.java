...
package com.androidpdfviewdowload.createpdf.lowagie.examples.objects.images.tiff;
...
public class OddEven {
	...
	public static void main(String[] args) {
		...
		try {
			RandomAccessFileOrArray odd = new RandomAccessFileOrArray(PdfTestRunner.getActivity().getResources().openRawResource(R.raw.odd));
			RandomAccessFileOrArray even = new RandomAccessFileOrArray(PdfTestRunner.getActivity().getResources().openRawResource(R.raw.even));
			...
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + args[2]));
			document.open();
