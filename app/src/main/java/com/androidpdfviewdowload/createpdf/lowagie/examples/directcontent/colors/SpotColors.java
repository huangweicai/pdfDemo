...
public class SpotColors {
	...
	public static void main(String[] args) {
		...
		try {
			...
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + "spotcolor.pdf"));
			...
			// Note: I made up these names unless someone give me a PANTONE
			// swatch as gift (phillip@formstar.com)
