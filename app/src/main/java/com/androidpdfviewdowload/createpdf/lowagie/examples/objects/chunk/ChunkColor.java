...
package com.androidpdfviewdowload.createpdf.lowagie.examples.objects.chunk;
...
public class ChunkColor {
	...
	public static void main(String[] args) {
		...
		try {
			...
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + "ChunkColor.pdf"));

			// step 3: we open the document
			document.open();
			// step 4:
			Font red = FontFactory.getFont(FontFactory.HELVETICA, Font.DEFAULTSIZE, Font.BOLD, new Color(0xFF, 0x00,
					0x00));
