			...
			try {
				...
				while (f < args.length - 1) {
					...
					if (f == 0) {
						...
						// document
						writer = new PdfCopy(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + outFile));
