 ...
 */
package com.androidpdfviewdowload.createpdf.lowagie.examples.objects.images;
...
//				cover.setFront(Image.getInstance(args[3]));
	...
	public void generatePdf() {
		...
		try {
			...
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + filename));
			...
			if (side != null) {
				...
				side
						.setAbsolutePosition(370 + (40f - side.getScaledWidth()) / 2f,
