 ...
 */
package com.androidpdfviewdowload.createpdf.lowagie.examples.objects.tables.pdfptable;
...
public class WriteSelectedRows {
	...
	public static void main(String[] args) {
		...
		try {
			// step2
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + "WriteSelectedRows.pdf"));
			// step3
			document.open();
			// step4
