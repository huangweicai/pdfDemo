...
public class RightToLeft {
	...
	public static void main(String[] args) {
		try {
			...
			// step 2
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + "righttoleft.pdf"));
			// step 3
			document.open();
			// step 4
...
//			BaseFont bf = BaseFont.createFont("c:\\windows\\fonts\\times.ttf", BaseFont.IDENTITY_H, true);
			...
			BaseFont bf = BaseFont.createFont("freeserif.ttf", BaseFont.IDENTITY_H, true, false, buffer, null);
	...
	public static String ar3 = "\u062a\u0633\u062c\u0651\u0644 \u0627\u0644\u0622\u0646 \u0644\u062d\u0636\u0648\u0631 \u0627\u0644\u0645\u0624\u062a\u0645\u0631 \u0627\u0644\u062f\u0648\u0644\u064a "
			...
			+ "\u062d\u062f \u0633\u0648\u0627\u062bfComic1 \u0645\u0646\u0627\u0642\u0634\u0629 \u0633\u0628\u0644 \u0627\u0633\u062a\u062e\u062f\u0627\u0645 \u064a\u0648\u0646\u0643\u0648\u062f  \u0641\u064a "
