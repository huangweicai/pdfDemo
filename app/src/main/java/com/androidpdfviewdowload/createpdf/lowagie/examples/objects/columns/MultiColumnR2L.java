...
public class MultiColumnR2L {
	...
	public static void main(String[] args) {
		...
		try {
			...
			OutputStream out = new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + "multicolumnR2L.pdf");
