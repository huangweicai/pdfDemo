...
public class CellColors {
	...
	public static void main(String[] args) {
		...
		try {
			// step2
			PdfWriter.getInstance(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + "CellColors.pdf"));
			// step3
			document.open();
			// step4
