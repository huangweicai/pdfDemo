...
package com.androidpdfviewdowload.createpdf.lowagie.examples.fonts.getting;
...
public class UsingFontFactory {
	...
	public static void main(String[] args) {
		...
		try {
			...
			PdfWriter.getInstance(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + "FontFactory.pdf"));
