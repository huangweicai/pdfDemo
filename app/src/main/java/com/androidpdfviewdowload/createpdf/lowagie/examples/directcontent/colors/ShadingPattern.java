...
public class ShadingPattern {
	...
	public static void main(String[] args) {
		...
		try {
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + "shading_pattern.pdf"));
			document.open();
