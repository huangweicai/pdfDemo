...
public class PageLabels {
	...
	public static void main(String[] args) {
		...
		try {
			// step 2:
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + "PageLabels.pdf"));
			// step 3:
