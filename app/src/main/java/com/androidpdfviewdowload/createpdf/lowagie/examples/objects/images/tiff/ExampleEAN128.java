...
public class ExampleEAN128 {
	...
	public static void main(String[] args) {
		...
		try {
			// step 2
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(android.os.Environment.getExternalStorageDirectory() + java.io.File.separator + "droidtext" + java.io.File.separator + "ean128.pdf"));
			// step 3
			document.open();
			// step 4
			...
			// Data for the barcode : it is composed of 3 blocks whith AI 402,
			// 90 and 421
			// The blocks whith the type 402 and 90 are of variable size so you
			// must put a FNC1
